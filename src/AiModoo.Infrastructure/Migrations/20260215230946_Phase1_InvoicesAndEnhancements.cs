...
{
    /// <inheritdoc />
    public partial class Phase1_InvoicesAndEnhancements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    SequencePrefix = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Journals_Accounts_DefaultCreditAccountId",
                        column: x => x.DefaultCreditAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Journals_Accounts_DefaultDebitAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankAccounts_Journals_JournalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NarrationAr = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    PostedById = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JournalEntries_Journals_JournalId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxGroupDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaxGroupDetails_TaxGroups_TaxGroupId",
                        column: x => x.TaxGroupId,
                        principalTable: "TaxGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaxGroupDetails_Taxes_TaxId",
                        column: x => x.TaxId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerNameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    JournalId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_FiscalPeriods_FiscalPeriodId",
                        column: x => x.FiscalPeriodId,
                        principalTable: "FiscalPeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Invoices_ReversalOfId",
                        column: x => x.ReversalOfId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyId = table.Column<int>(type: "int", nullable: true),
                    AmountCurrency = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsReconciled = table.Column<bool>(type: "bit", nullable: false),
                    ReconcileGroupId = table.Column<int>(type: "int", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_JournalId",
                table: "BankAccounts",
                column: "JournalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_FiscalPeriodId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_JournalId1",
                table: "JournalEntries",
                column: "JournalId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Journals_DefaultCreditAccountId",
                table: "Journals",
                column: "DefaultCreditAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Journals_DefaultDebitAccountId",
                table: "Journals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxGroupDetails_TaxGroupId",
                table: "TaxGroupDetails",
                column: "TaxGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxGroupDetails_TaxId",
                table: "TaxGroupDetails",
                column: "TaxId");
        }
